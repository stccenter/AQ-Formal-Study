...
def train_model(X_train, y_train, X_test, y_test, eta, max_depth, n_estimators):
    # Adjust the model to function like a Random Forest
    model = XGBRegressor(booster='gbtree', eta=eta, max_depth=max_depth,
                         n_estimators=n_estimators, subsample=1, colsample_bytree=1)
