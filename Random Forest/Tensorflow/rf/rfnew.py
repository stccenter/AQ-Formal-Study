...
with open("rf_7030.txt", "a") as results_file:
    for i in range(5):
        ...
        # results
        result_string = f"Model {i + 6}: RMSE = {math.sqrt(mse)}, R² = {r2}, Time: {elapsed_time} seconds\n"
        print(result_string)
...
with open("rf_7030aggregate.txt", "a") as results_file:  
