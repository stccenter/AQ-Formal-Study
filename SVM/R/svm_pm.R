...
for(i in c(1:2)){
  ...
  #save model
  write_rds(svm_model_pm,str_c("/Users/ttrefoni/Documents/tt_pm25tuning/output_models/svm_model_12_15_",i))
...
write_csv(test_sum,"/Users/ttrefoni/Documents/tt_pm25tuning/output/svm_pm_results_12_15.csv")
# write to  file  ---------------------------------------------------------
file.create("/Users/ttrefoni/Documents/tt_pm25tuning/output/svm_pm_results_12_15.txt")
file_con <- "/Users/ttrefoni/Documents/tt_pm25tuning/output/svm_pm_results_12_15.txt"
