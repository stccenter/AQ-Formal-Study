...
for(i in c(1:10)){
  ...
  time_start<-Sys.time()
  rf_model_pm <- caret::train(epa_pm25~.,data=train_x,preProcess=c("center","scale"), method="ranger",tuneGrid=rf_grid,trControl=fitControl)
  time_end<-Sys.time()
  time_tr_1<-as_hms(time_end-time_start)
  
  #save model
  write_rds(rf_model_pm,str_c("/Users/ttrefoni/Documents/tt_pm25tuning/output_models/rf_n_model_01_05_70_30_",i))
...
write_csv(test_sum,"/Users/ttrefoni/Documents/tt_pm25tuning/output/rf_n_pm_results_01_05_70_30.csv")
# write to  file  ---------------------------------------------------------
file.create("/Users/ttrefoni/Documents/tt_pm25tuning/output/rf_n_pm_results_01_05_70_30.txt")
file_con <- "/Users/ttrefoni/Documents/tt_pm25tuning/output/rf_n_pm_results_01_05_70_30.txt"
