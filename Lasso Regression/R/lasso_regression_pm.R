...
for(i in c(1:10)){
  ...
  #save model
  write_rds(LR_model_pm,str_c("/Users/ttrefoni/Documents/tt_pm25tuning/output_models/LR_n_model_01_05_70_30_",i))
...
write_csv(test_sum,"/Users/ttrefoni/Documents/tt_pm25tuning/output/LR_n_pm_results_01_05_70_30.csv")
# write to  file  ---------------------------------------------------------
file.create("/Users/ttrefoni/Documents/tt_pm25tuning/output/LR_n_pm_results_01_05_70_30.txt")
file_con <- "/Users/ttrefoni/Documents/tt_pm25tuning/output/LR_n_pm_results_01_05_70_30.txt"
