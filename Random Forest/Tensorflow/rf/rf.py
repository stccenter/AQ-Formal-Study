...
with open("rfregressor_80202", "w") as results_file:
    for i in range(10):
        ...
        # type of model
        regression_model = tfdf.keras.RandomForestModel(task=tfdf.keras.Task.REGRESSION)
        ...
        # results
        hyperparameters_str = str(regression_model.get_config())
        result_string = f"{i + 1},{hyperparameters_str},{math.sqrt(mse)},{r2},{elapsed_time}\n"
...
with open("rfregressor_8020aggregate2", "w") as results_file:  
