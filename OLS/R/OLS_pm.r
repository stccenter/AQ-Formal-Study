...
for(i in c(1:10)){
  ...
  #save model
  write_rds(OLS_model_pm,str_c("/Users/ttrefoni/Documents/tt_pm25tuning/output_models/OLS_n_model_1_5_70_30",i))
...
write_csv(test_sum,"/Users/ttrefoni/Documents/tt_pm25tuning/output/OLS_n_pm_results_01_05_70_30.csv")
# write to  file  ---------------------------------------------------------
file.create("/Users/ttrefoni/Documents/tt_pm25tuning/output/OLS_n_pm_results_01_05_70_30.txt")
file_con <- "/Users/ttrefoni/Documents/tt_pm25tuning/output/OLS_n_pm_results_01_05_70_30.txt"
