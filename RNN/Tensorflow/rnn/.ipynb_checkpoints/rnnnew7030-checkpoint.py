...
with open("rnn_8020.txt", "w") as results_file:
    for i in range(10):
        ...
        model.compile(optimizer=Adam(learning_rate=0.001), loss='mean_squared_error', metrics=[RootMeanSquaredError(), r2_score])
...
with open("rnn_8020aggregate.txt", "w") as results_file:
